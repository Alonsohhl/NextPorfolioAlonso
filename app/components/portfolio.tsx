  ...
  return (
    <div className="p-3 picture-item " id={String(key)}>
      <div className="relative block overflow-hidden rounded group transition-all duration-500 h-80">
        ...
        <Link
          href={"/portfolio/" + slug}
          className="absolute inset-3 flex items-end cursor-pointer rounded bg-white p-3 opacity-0 transition-all duration-500 group-hover:opacity-80 group-hover:backdrop-blur-sm"
        >
          <div>
